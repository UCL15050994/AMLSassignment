...
This module was used to find the optimal hyperparameters for the logistic  
regression/softmax classifiers used for all the tasks using GridSearchCV. 
3-fold cross validation is used and relevant metrics are obtained.
"""
...
#Using a logistic regression/softmax regression classifier from sklearn
#solver is set to 'lbfgs' for all the tasks
#multi_class should be set to 'ovr' for the binary tasks but should be changed
#to 'multinomial' for hair color classification (softmax regression)
#max_iter is set to 5000 for the solver to converge
logreg = linear_model.LogisticRegression(solver = 'lbfgs', multi_class = 'ovr', max_iter = 5000)
