...
This module was used to in order to create and write a .csv file for task 1 containing
all the predicitions of the chosen smiling model on a previously unseen dataset. Specifically,
