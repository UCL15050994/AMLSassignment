...
This module was used to in order to train the best model for eyeglasses detection and
...
#Facial landmarks are used for eyeglasses detection
form = 'landmarks'
label = 'eyeglasses'
...
dump(classifier, 'models/eyeglasses.model')
