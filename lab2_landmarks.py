...
This module used in the second lab session has been modified slightly. Changes
are indicated below.
"""
import os
import numpy as np
...
# PATH TO ALL IMAGES
#Modification: the path was modified as appropriate
global basedir, image_paths, target_size
basedir = './dataset'
images_dir = './images1'
labels_filename = 'data.csv'
...
#Modification: adding a column name parameter col_name to be passed to the 
#function for convenience 
def extract_features_labels(col_name):
    """
