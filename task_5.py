...
This module was used to in order to create and write a .csv file for task 5 containing
all the predicitions of the chosen hair color model on a previously unseen dataset. Specifically,
the model used is an SVM with a polynomial kernel and C = 0.01 previously trained on RGB values
from cropped and resized images.
"""
...
for file in filenames:
    ...
    #Cropping the image to only include the top half for hair color model
