...
This module was used to in order to create and write a .csv file for task 3 containing
all the predicitions of the chosen eyeglasses model on a previously unseen dataset. Specifically,
...
test_data, failed_data = l2.extract_features('eyeglasses')
